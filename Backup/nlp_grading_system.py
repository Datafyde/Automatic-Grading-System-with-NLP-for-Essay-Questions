...
similarity between student and correct essay answers. This system automates the grading process, ensuring accuracy and
 efficiency.
...
## Conclusion
The **Automatic Grading System** simplifies the evaluation process, providing fast and accurate grading for MCQs and
essays.
    ...
    if key_file and response_file and key_df is not None and response_df is not None:
        if st.button("Show Results", type="primary"):
            ...
            if mcq_scores is not None and essay_scores is not None:
                final_scores = (pd.concat([mcq_scores, essay_scores]).groupby('StudentID', as_index=False)['Score'].
                                sum())
...
def user_guide_page():
    ...
    st.image(
      "https://raw.githubusercontent.com/Datafyde/Automatic-Grading-System-with-NLP-for-Essay-Questions/main/"
      "User%20Guide/Step%201.png",
    ...
    st.image(
      "https://raw.githubusercontent.com/Datafyde/Automatic-Grading-System-with-NLP-for-Essay-Questions/main/"
      "User%20Guide/Step%203%20Error%20Message.png",
      caption="Invalid Uploaded Files",
      width=700
    )
    st.image(
      "https://raw.githubusercontent.com/Datafyde/Automatic-Grading-System-with-NLP-for-Essay-Questions/main/"
      "User%20Guide/Step%203%20Fixed.png",
    ...
    st.image(
      "https://raw.githubusercontent.com/Datafyde/Automatic-Grading-System-with-NLP-for-Essay-Questions/main/"
      "User%20Guide/Step%205%20Scores.png",
    ...
    st.image(
      "https://raw.githubusercontent.com/Datafyde/Automatic-Grading-System-with-NLP-for-Essay-Questions/main/"
      "User%20Guide/Step%205%20Chart.png",
